...
async function Page() {
  return (
    <div className="grid grid-cols-1 gap-2 *:col-span-full lg:gap-4">
      <p>
        Hi, I’m Dan. Currently {"I'm"} the lead engineer at <Link href="https://madeincookware.com">🍳Made In</Link>,
        and before that I was at <Link href="https://www.msrenewal.com">🏡Amherst</Link> and{' '}
